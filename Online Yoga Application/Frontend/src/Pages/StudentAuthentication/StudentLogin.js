...
export default function StudentLogin() {
  ...
  let loginAction = async () => {
    ...
    try {
      ...
      localStorage.setItem("userId", list.id);
    ...
    <div className="containerr">
      ...
      <div className="signin-signup justify-content-center ">
        <div className="row justify-content-center sign-up-form ms-4">
          <h2 className="title" style={{ paddingLeft: "100px" }}>
            Sign in
          </h2>
          <form
            ref={formRef}
            className="needs-validation form-control"
            style={{ border: "none", paddingLeft: "100px" }}
          >
            <Form.Group>
              <input
                type="email"
        ...
        <div className="panel left-panel">
          <div className="content">
            ...
            <Link
              ...
              style={{ flex: "0.1", textDecoration: "none", color: "white" }}
            >
              <button className="btn transparent" id="sign-up-btn text-light">
                Sign up
              </button>
            </Link>
          </div>
