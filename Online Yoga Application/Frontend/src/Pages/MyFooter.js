...
const MyFooter = () => {
    return (
        <div>
            <footer id="footer">
                <h1><span>S</span>adhana</h1>
                <p> “A quiet mind is the healthiest mind”</p>
...
//   return (<>
//     <footer id="footer" className="footer-1 bg-dark" style={{color:"#00bcd4", marginTop:"0px"}}>
//       <div className="main-footer widgets-dark typo-light">
//         <div className="container mt-0">
//           <div className="row pt-5">
//             <div className="col-xs-12 col-sm-6 col-md-3 pt-5">
//               <div className="widget subscribe no-box pt-5">
//                 <h5 className="widget-title">
//                   Quize Conductor<span></span>
//                 </h5>
...
//                 </h5>
//                 <ul className="thumbnail-widget footerlist">
//                   <li>
...
//                 <p className="mailto">
//                   <a href="mailto:info@domain.com" title="glorythemes" style={{color:"#00bcd4"}}>
//                     info@domain.com
//                   </a>
//                 </p>
