...
const validationSchema = Yup.object({
    ...
    fname:Yup.string().required('Required').matches(/^[A-za-z]+$/,"First name is not valid"),
    lname:Yup.string().required('Required').matches(/^[A-za-z]+$/,"First name is not valid"),
       ...
       <div className="plashBox">
           ...
           <Container maxWidth="lg">
                ...
                <Grid container spacing={3}>
                    <Grid item xs={6} md={3} className="alPostLeft">
                    ...
                    <Grid item  xs={12} md={6} className="alPostMid">
...
<Paper className="myPaper" >
                ...
                <Grid item md={6} xs={12}>
                    ...
                    <Grid item md={6} xs={12}>
                     <Button><a href = {process.env.PUBLIC_URL + `/uploads/${download}`} target = "_blank" style={{color:"white"}}>Download Assignment</a></Button>   
                    </Grid>            
