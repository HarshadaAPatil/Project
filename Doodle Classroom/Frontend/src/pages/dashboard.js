       ...
       <div className="plashBox">
           ...
           <Container maxWidth="lg">
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} xmd={6}  className="alPostMid">
                        <span>
...
<Grid container spacing={4} style={{marginTop:'10px',marginBottom:'10px'}}>
      ...
      <Grid item xs={12} md={6}>
            <Paper elevation={5} className="box-home2">
            <div className="btn-title" >    
            <h3 onClick={()=>history.push("/viewstudent")} >View Students({studcount})</h3> 
            </div>
            </Paper>
      </Grid>
      <Grid item xs={12} md={6} >
            <Paper elevation={5} className="box-home2">
            <div className="btn-title" >    
            <h3 onClick={()=>history.push("/viewteacher")}>View Teachers ({tcount})</h3> 
            </div>
            </Paper>
      </Grid>
